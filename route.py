...
class Route():
    def __init__(self):
        self.dbUsers=User()
        self.Program=Directory("become 1 electrician")
    ...
    def save_user(self,params={}):
        myparam=self.get_post_data()(params=("description","job_id","country_id","phone","email","gender","mypic","password","password_security","nomcomplet"))
